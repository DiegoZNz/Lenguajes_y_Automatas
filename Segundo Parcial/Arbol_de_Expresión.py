...
#Construye el arbol de expresión para la ecuación f(x) = 2x^8 - x^7 + 3x^6 + x^5 - 2x^4 - 2x^3 + 3x^2 - 4x +5
...
#Evalúa la expresión de manera interactiva
while True:
        try:
            ...
            print(f'El resultado de la expresión para x = {x} es: {resultado}')
